...
These numerical invariants are typically very difficult to calculate in general, and have been the 
focus of intense study over the past fifteen years.
This \emph{Macaulay2} package is centered around calculating 
and estimating the $F$-pure threshold and other $F$-thresholds. 
