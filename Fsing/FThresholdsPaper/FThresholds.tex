...
This paper describes a Macaulay2 package which provides tools to compute, $F$-pure thresholds, $F$-thresholds and $F$-jumping numbers.  We begin with some history

{\it Acknowledgements}  The authors thank...
...
\]
where $\bullet^{[1/p^e]}$ is defined as in the {\tt TestIdeals} package.  These are controlled by {\tt ContainmentTest => StandardPower} and {\tt ContainmentTest => FrobeniusRoot} respectively.
...
\section{{\tt isFPT} and {\tt isFJumpingExponent}}
