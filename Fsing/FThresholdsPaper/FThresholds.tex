...
Given a rational number $t$ and  an element $f$ of a $\mathbb{Q}$-Gorenstein ring $R$ of characteristic $p>0$, 
the command {\tt isFPT(t, f)} checks whether $t$ is the $F$-pure threshold of $f$.  
