...
The notion of $F$-purity first appeared in the work of Hochster and Roberts \cite{HochsterRobertsFrobeniusLocalCohomology}, was compared with rational singularities \cite{FedderFPureRat}, and was used globally to study properties of Schubert varieties in \cite{MehtaRamanathanFrobeniusSplittingAndCohomologyVanishing}.
...
Furthermore, the more general notion of \emph{$F$-thresholds}, which includes the $F$-pure threshold, was also introduced. 
These numerical invariants are typically very difficult to calculate, and due to their significance, have been the focus of intense study over the past fifteen years.
This \emph{Macaulay2} package is centered around calculating and estimating the $F$-pure threshold and other $F$-thresholds, with the function {\tt fpt} at its core. 
