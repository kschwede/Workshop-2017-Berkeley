...
\setstretch{.67}
\begin{MyVerbatim}
i2 : R = ZZ/3[x,y,z]/ideal( x^3 + y^4 + z^5 );
...
o6 = 1i2 : R = ZZ/3[x,y,z]/ideal( x^3 + y^4 + z^5 );
...
i3 : f = x^3 + y^2*z + y*z^2;

i4 : frobeniusPower(1/2, ideal f)
...
i6 : frobeniusPower(1/4, ideal u)

o6 = ideal (z, y, x)

o6 : Ideal of R

i7 : ((FPureModule(1, f))#3) + 1
...
i3 : f = y^2*z^3 - x^5 - 2*z^5;

i4 : frobeniusPower(1/11, ideal f^10)
...
\setstretch{.67}
\begin{MyVerbatim}
i7 : omega = canonicalIdeal S

o7 = ideal (e, d, a)

o7 : Ideal of S

i8 : omega = substitute(omega, R) + I;

o8 : Ideal of R

i9 : u = intersect((frobenius I):I, (frobenius omega) : omega);

o9 : Ideal of R

i10 : u = compress((gens u) % gens(frobenius I))

o10 = | a3bc+a3bd+a2cde+abcde+abd2e+b2d2e+cd2e2+d3e2 |

              1       1
o10 : Matrix R  <--- R

i11 :  u = first first entries u

       3       3       2                         2     2 2       2 2    3 2
o11 = a b*c + a b*d + a c*d*e + a*b*c*d*e + a*b*d e + b d e + c*d e  + d e
...
\setstretch{.67}
\begin{MyVerbatim}
 print \ unique apply(L, J -> J : omega);
       3       3       2                         2     2 2       2 2    3 2
ideal(a b*c + a b*d + a c*d*e + a*b*c*d*e + a*b*d e + b d e + c*d e  + d e )
               2
ideal (a + b, b  + d*e)
