...
stabilizes.
\end{definition}
This invariant was introduced in \cite{AlvarezBlickleLyubeznik2005}. One interesting particular
...
$(R/(f))_{(x,y,z)}$ is $F$--pure \cite{TakTak08}) and supersingular if and only if its level is $2.$ When
...
i3 : frobeniusPower( 1/11, ideal f )
             2        3
o3 = ideal (z , x*z, x )
o3 : Ideal of R
i4 : u=f^{121-1};
i5 : frobeniusPower( 1/121, ideal u )
             2        3
o6 = ideal (z , x*z, x )
o6 : Ideal of R
\end{MyVerbatim}
