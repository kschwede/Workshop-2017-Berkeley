...
This feature can be disabled by setting the option \texttt{UseSpecialAlgorithms} (default value \texttt{true}) to \texttt{false}; in Section~\ref{ss: UseSpecialAlgorithms} we discuss situations in which this may be desirable.
