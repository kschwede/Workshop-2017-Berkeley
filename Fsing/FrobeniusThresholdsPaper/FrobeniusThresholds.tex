...
\setstretch{.67}
\begin{MyVerbatim}
i10 : time nu(2, m, m^2, Search => Linear)
...
\setstretch{.67}
\begin{MyVerbatim}
i11 : nu(5, x^2*y^4 + y^2*z^7 + z^2*x^8, ReturnList => true)
...
\setstretch{.67}
\begin{MyVerbatim}
i15 : time nu(3, f, ContainmentTest => StandardPower)
...
i19 : nu(4, m^5, ContainmentTest => FrobeniusPower)
...
i23 : time nu(10, f, UseSpecialAlgorithms => false)
...
In the following example, we compute the $F$-pure threshold of a diagonal polynomial.
