...
i9 : time nu(2, m, m^2) -- uses binary search (default)
     -- used 1.82479 seconds

o9 = 97

i10 : time nu(2, m, m^2, Search => Linear) -- but linear search gets luckier
...
i14 : time nu(3, f) -- ContainmentTest is set to FrobeniusRoot, by default
...
i21 : f = x^3 + y^4 + z^5; -- a diagonal polynomial
